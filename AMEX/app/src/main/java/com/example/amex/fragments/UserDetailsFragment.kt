package com.example.amex.fragments
...
import com.example.amex.interfaces.MyBlockchainApi
import com.example.amex.interfaces.MyMLApi
import com.example.amex.models.FileinModel
...
class UserFInancialDetailsFragment : Fragment() {
    ...
    private lateinit var FInancialType:String
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_User_FInancial_details, container, false)
        ...
        et4 = view.findViewById(R.id.etFInancialAmount)
        et5 = view.findViewById(R.id.etFInancialTerm)
        ...
        val tvFInancialType:TextView = view.findViewById(R.id.tvFInancialType)
...
//        }
        ...
        tvFInancialType.text = FInancialType
        btnNext.setOnClickListener {
            if(et1.text.isNullOrEmpty()|| et2.text.isNullOrEmpty()|| et3.text.isNullOrEmpty()|| et4.text.isNullOrEmpty()|| et5.text.isNullOrEmpty()|| et6.text.isNullOrEmpty()|| et7.text.isNullOrEmpty()|| et8.text.isNullOrEmpty()|| et9.text.isNullOrEmpty()|| et10.text.isNullOrEmpty() ||
                ...
                getOutputFromML()
//                saveFInancialDetailsInDatabase()
//                postData()
            }
        }
        return view
...
//        }
    ...
    private fun initializeData(){
        FInancialType = arguments?.getString("FInancialType")!!
    ...
    private fun saveFInancialDetailsInDatabase(mlOutput:String){
        dialogBox("Saving Data in Database","Please wait")
        val sharedPreferences = requireContext().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
        val scoreReceived = sharedPreferences.getString("testScore","")!!
        var FInancialData = FInancialDataModel(userName, uid, email, FInancialType, et1.text.toString(), et2.text.toString(), scoreReceived, et3.text.toString(), et4.text.toString(), et5.text.toString(), et6.text.toString(), et7.text.toString(), et8.text.toString(), et9.text.toString(), et10.text.toString(), mlOutput)
        database.reference.child("FInancials")
            .child(uid)
            .setValue(FInancialData)
...
//                        resultTextView.text = "Prediction: ${myResponse.prediction}"
                        ...
                        if(statusFromML == "1"){
                            mlOutput = "Accepted"
                            saveFInancialDetailsInDatabase(mlOutput)
                            postData(mlOutput)
                        }
