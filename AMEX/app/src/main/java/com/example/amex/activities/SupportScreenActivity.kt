...
import com.example.amex.adapters.MessageAdapter
import com.example.amex.databinding.ActivitySupportScreenBinding
import com.example.amex.models.MessageModel
...
//    private var BANK_ID = "0Rl5g5tbbLfZl9DV5GGlsrmxZKq1"
...
//        checkBANKStatusFromDB()
    ...
    private fun checkBANKStatusFromDB(){
        dialogBox("Retrieving BANK? Status Data from FB Realtime DB","Please Wait ...")
