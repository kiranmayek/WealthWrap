...
import com.example.amex.adapters.PdfAdapter
import com.example.amex.databinding.ActivityDocsDetailsBinding
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for(snapshot1 in snapshot.children){
                        val data = snapshot1.getValue(FinancialDataModel::class.java)
                        if(data!!.uid == uid){
                            binding.tv10.text = data.name
                            binding.tv11.text = data.uid
                            binding.tv12.text = data.FinancialType
                            ...
                            binding.tv16.text = data.etFinancialAmount
                            binding.tv3.text = data.etFinancialTerm
