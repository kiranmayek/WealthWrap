...
import com.example.amex.databinding.ActivityStatusScreenBinding
...
class StatusScreenActivity : AppCompatActivity() {
    ...
    private fun getStatusFromDatabase(){
        dialogBox("Fetching your Financial status","Please wait...")
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    for(snapshot1 in snapshot.children){
                        ...
                        if(data!!.uid == uid){
                            ...
                            binding.tvFinancialType.text = data!!.FinancialType
                            if(status == "Accepted"){
